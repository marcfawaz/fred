...
from knowledge_flow_backend.core.processors.input.lightweight_markdown_processor.lite_csv_to_md_processor import (
    LiteCsvToMdProcesor,
)
...
class FastLiteCsvProcessor(BaseFastTextProcessor):
    """Adapter to use LiteCsvToMdProcesor within the FastText infrastructure."""
