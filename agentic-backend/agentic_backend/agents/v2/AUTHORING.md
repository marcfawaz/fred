...
Full guide: [`production/basic_react/AUTHORING.md`](production/basic_react/AUTHORING.md)
...
Full guide: [`production/basic_deep/AUTHORING.md`](production/basic_deep/AUTHORING.md)
...
A working sample lives in [`samples/tutorial_tools/agent.py`](samples/tutorial_tools/agent.py).
